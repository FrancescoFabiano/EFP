...
bool
is_consistent (StringList sl1, StringList sl2)
{
...
StringList2
join_SL2 (StringList2 input1, StringList2 input2)
{
...
void
printStringList2 (StringList2 in)
{
  StringList2::iterator it1;
  cout << "[ ";
  for (it1 = in.begin (); it1 != in.end (); it1++)
