...
void printstring_set(string_set);
void printstring_set_set(string_set_set);
...
void
printstring_set_set(string_set_set in)
{
	string_set_set::iterator it1;
	std::cout << "[ ";
	for (it1 = in.begin(); it1 != in.end(); it1++) {
