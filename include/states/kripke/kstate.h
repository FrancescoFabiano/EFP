...
private:
    ...
    void sum_kworld_ptr_set(kworld_ptr_set & to_modify, const kworld_ptr_set & factor2) const;
    ...
    void minus_kworld_ptr_set(kworld_ptr_set & to_modify, const kworld_ptr_set & factor2) const;
...
public:
     ...
     *  
     * @param[in] to_add: the \ref kworld that has to be added to *this*.*/
    void add_rep_world(const kworld & to_add);
