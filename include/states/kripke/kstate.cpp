...
void kstate::print_ML_dataset_dual(const std::string& folder, const std::string& base_filename) const
{
...
{
	std::cerr << "Function print_graphviz_explicit not yet implmented for K structures.";
	exit(1);
}
