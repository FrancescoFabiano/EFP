...
//class kworld_ptr;
typedef std::set<const kworld*> kworld_set; /**< \brief A set of \ref kworld_ptr.
                                            *
...
//
//typedef std::map<std::pair<kworld*, event_type>, kworld*> kstate_map;

typedef std::map<const kworld*, std::map<const agent*, std::set<const kworld*>>> kedge_map;
...
typedef std::map<kworld*, std::map<kworld*, bis_label_set> > kbislabel_map;
