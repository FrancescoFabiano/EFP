...
bool
State::satisfies (const Literals* x)
{
  Literals::const_iterator it;
...
bool
State::intersect (const Literals* x) const
{
...
bool
State::intersect (const State* s) const
{
  return intersect (&s->m_literals);
}

bool
State::includes (const Literals* x) const //includes(const list of list of short int)
{
...
bool
State::includes (const State* s) const
{
...
void
CState::set_plan_length (const int& len)
{
  m_plan_length = len;
}

int
CState::get_plan_length () const
{
  return m_plan_length;
}

void
CState::set_action (const Action* act)
{
  m_action = act;
}
...
void
CState::set_sensing (const Action* act)
{
  sensing = act;
}

void
CState::set_ontic (const Action* act)
{
  ontic = act;
}

void
CState::set_ann (const Action* act)
{
  ann = act;
}
...
const Action*
CState::get_sensing () const
{
  return sensing;
}

const Action*
CState::get_ontic () const
{
  return ontic;
}

const Action*
CState::get_ann () const
{
  return ann;
}
...
void
CState::set_previous_cstate (const CState* cs)
{
  m_previous_cstate = cs;
}

const CState*
CState::get_previous_cstate () const
{
