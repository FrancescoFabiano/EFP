...
const formula_list & kevent::get_precondition() const
{
    return m_pre;
}
...
const event_postconditions & kevent::get_postconditions() const
{
    return m_post;
}
...
const formula_list & kevent_ptr::get_precondition() const
{
    if (m_ptr != nullptr) {
...
const event_postconditions & kevent_ptr::get_postconditions() const
{
    if (m_ptr != nullptr) {
