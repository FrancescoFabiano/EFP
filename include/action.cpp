...
void
Effect::set_head (Literals hd)
{
  m_head = hd;
}

const Literals*
Effect::get_body () const
{
  return &m_body;
}

const Literals*
Effect::get_neg_body () const
{
  return &m_neg_body;
}

const Literals*
Effect::get_head () const
{
  return &m_head;
}
...
void
Fluents_BF::set_l_head (Literals bd)
{
  l_head = bd;
}

void
Fluents_BF::set_bn_body (const BFNode& node)
{
  b_body = node;
}

const Literals*
Fluents_BF::get_head () const
{
  return &l_head;
}

const BFNode*
Fluents_BF::get_body () const
{
  return &b_body;
}
...
void
Agent_FF::set_a_head (Agent ag)
{
  a_head = ag;
}

void
Agent_FF::set_ff_body (FluentFormula ff)
{
  ff_body = ff;
}

Agent
Agent_FF::get_head () const
{
  return a_head;
}

FluentFormula
Agent_FF::get_body () const
{
  return ff_body;
}
...
void
KAction::set_name (const string& name)
{
  m_name = name;
}

void
KAction::set_type (const PropositionType pt)
{
  m_type = pt;
}

string
KAction::get_name () const
{
  return m_name;
}
...
/* main functions */
void
KAction::add_execs (const BFNode& ex)
{
  m_execs.push_back (ex);
}

void
KAction::add_effect (Literals hd, const BFNode& bd)
{
  Fluents_BF ef;
...
void
KAction::add_observes (const Agent& ag, const FluentFormula& ff)
{
  Agent_FF af;
  af.set_a_head (ag);
  af.set_ff_body (ff);
...
void
KAction::add_awares (const Agent& ag, const FluentFormula& ff)
{
  Agent_FF af;
  af.set_a_head (ag);
  af.set_ff_body (ff);
...
void
KAction::add_sensedFluents (const Literals& f)
{
  sensedFluents.push_back (f);
}

void
KAction::add_ann_ff (const FluentFormula& ff)
{
  annFFs.push_back (ff);
}

const Nodes*
KAction::get_execs () const
{
  return &m_execs;
}

const Fluents_BF_list*
KAction::get_effects () const
{
  return &m_effects;
}

Agent_FF_list
KAction::get_m_observes () const
{
  return m_observes;
}

Agent_FF_list
KAction::get_m_awares () const
{
  return m_awares;
}

const PropositionType
KAction::get_type () const
{
  return m_type;
}

const Literals
KAction::get_sensedFluents () const
{
  Literals out;
...
const list<FluentFormula>
KAction::get_ann_ff () const
{
  return annFFs;
}
