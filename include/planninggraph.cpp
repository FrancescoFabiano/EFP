...
string
EpistemicModelsNode::get_action ()
{
  return action;
}

void
EpistemicModelsNode::set_action (string s)
{
  action = s;
}

void
EpistemicModelsNode::set_Kripke (Kripke* k)
{
  kripke = k;
}

void
EpistemicModelsNode::add_pointedID (int i)
{
  pointeds.insert (i);
}

Kripke*
EpistemicModelsNode::get_Kripke ()
{
  return kripke;
}

set<int>
EpistemicModelsNode::get_pointeds ()
{
  return pointeds;
}

void
EpistemicModelsNode::print_info ()
{
...
void
PGraphActionLevel::set_ActionVec (set<string> actions)
{
  actionVec = actions;
}

void
PGraphActionLevel::add_action (string a)
{
  actionVec.insert (a);
}

set<string>
PGraphActionLevel::get_ActionVec ()
{
  return actionVec;
}

void
PGraphActionLevel::print_info ()
{
...
bool
PGraphENodeLevel::emNodes_entailment (vector<EpistemicModelsNode> v, BFNode bf)
{
...
bool
PGraphENodeLevel::emNodes_entailment (BFNode bf)
{
  return emNodes_entailment (eNodes, bf);
}

void
PGraphENodeLevel::set_eNodes (vector<EpistemicModelsNode> nodes)
{
  eNodes = nodes;
}

void
PGraphENodeLevel::add_eNode (EpistemicModelsNode node)
{
  eNodes.push_back (node);
}

vector<EpistemicModelsNode>
PGraphENodeLevel::get_eNodes ()
{
  return eNodes;
}

bool
PGraphENodeLevel::executable (KAction a)
{
...
void
PlanningGraph::add_K_level (PGraphENodeLevel e_nodes)
{
  k_levels = e_nodes;
}

void
PlanningGraph::add_A_level (PGraphActionLevel a_nodes)
{
  a_levels.push_back (a_nodes);
}

int
PlanningGraph::constructEPG (Kripke* kinput)
{
      ...
      if (!first)
        {
          ...
          if (satisfied)
            { //goals are satisfied at previous level, then return the lengthToGoal
...
EpistemicModelsNode
PlanningGraph::effect_ontic (Literal l, AgentSet fd, AgentSet od, string action)
{
...
EpistemicModelsNode
PlanningGraph::effect_sensing (Literal l, AgentSet fd, AgentSet pd, AgentSet od, string action)
{
...
EpistemicModelsNode
PlanningGraph::effect_announce (FluentFormula ff, AgentSet fd, AgentSet pd, AgentSet od, string action)
{
...
void
PlanningGraph::cartesian_product (list< vector<Literal> > sets, list< vector<Literal> >& product)
{
  if (sets.empty ())
    return;
...
AgentSet
PlanningGraph::get_fd (const KAction& act) const
{
...
AgentSet
PlanningGraph::get_pd (const KAction& act) const
{
  AgentSet out = AgentSet ();
  Agent_FF_list::iterator ia;
...
AgentSet
PlanningGraph::get_od (const KAction& act) const
{
