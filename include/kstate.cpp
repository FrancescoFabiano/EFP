...
void
Kstate::set_in (EdgeList in)
{
  edge_in = in;
}

void
Kstate::set_out (EdgeList out)
{
  edge_out = out;
}

void
Kstate::set_lits (Literals ls)
{
  lits = ls;
}

void
Kstate::set_id (int ident)
{
  id = ident;
}

void
Kstate::set_exist (bool ex)
{
  exists = ex;
}

map<int, set<int> >
Kstate::get_preparedMap ()
{
...
void
Kstate::add_to_map (int ag, int des)
{
...
bool
Kstate::entail_lit (Literal l) const
{
...
bool
Kstate::entail_lits (Literals ls) const
{
...
bool
Kstate::entail_fluform (FluentFormula ff) const
{
