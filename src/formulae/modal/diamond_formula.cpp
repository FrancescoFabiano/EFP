...
template<class M>
bool diamond_formula<M>::is_entailed(const kstate *state, const kworld *world) const {
...
template<class M>
bool diamond_formula<M>::is_entailed(const pstate *state, const pworld *world) const {
